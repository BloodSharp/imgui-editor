...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("ImGui Cheats Menus Collection", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
    if (window == nullptr)
    {
    ...
    IGCMC::Interfaces::ClearAllInterfaceData();
